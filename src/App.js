...
//             </svg>
                //config - moduł konfiguracyjny
                //CDN_IMAGE_SUFFIX - adres serwera + ścieżka lub sama ścieżka jeśli SERVER_URL = CDN_URL
                <img src={config.CDN_IMAGE_SUFFIX + 'trash.svg'} className='icon'/>
        )
    }
